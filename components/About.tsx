...
export default function About() {
  return (
    <section id="about" className="section-pad bg-brand-dark border-t border-white/5 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="flex-1 md:pr-10">
            ...
            <p className="text-brand-subtext text-lg leading-relaxed mb-14 max-w-xl">
              {PERSONAL.bio}
            </p>
            ...
            <div className="grid grid-cols-2 gap-10 pt-6 border-t border-white/5">
              <div className="glass-panel p-6 rounded-3xl transition-transform hover:-translate-y-1">
                <div className="text-blue-500 font-black text-4xl mb-1 drop-shadow-md">4+</div>
                <div className="text-xs text-zinc-500 font-semibold uppercase tracking-wider">Production Apps</div>
              </div>
              <div className="glass-panel p-6 rounded-3xl transition-transform hover:-translate-y-1">
                <div className="text-blue-500 font-black text-4xl mb-1 drop-shadow-md">Scale</div>
          ...
          <div className="flex-1 w-full max-w-md relative hidden md:block">
            <div className="absolute inset-0 bg-purple-500 blur-[120px] opacity-20 rounded-full" />
            <div className="relative aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-2xl group border border-white/10">
              ...
              <div className="absolute top-0 right-0 w-32 h-32 bg-black/40 backdrop-blur-md rounded-bl-[100px] border-b border-l border-white/10 flex items-center justify-center shadow-lg z-20">
                <div className="w-12 h-12 rounded-full border border-blue-500/30 flex items-center justify-center text-blue-500 font-bold bg-blue-500/10">
                  DK
                </div>
              </div>
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -left-6 p-4 rounded-2xl bg-brand-surface border border-white/10 shadow-2xl flex items-center gap-3 backdrop-blur-md"
            >
